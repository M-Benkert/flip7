...
from src.simple_agents.combined_threshold_agent import CombinedThresholdAgent
...
def test_combined_threshold_agent(flip7_env, score_threshold, number_of_cards_threshold):
    agent = CombinedThresholdAgent(score_threshold=score_threshold, number_of_cards_threshold=number_of_cards_threshold)
